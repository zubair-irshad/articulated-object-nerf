...
def visualize_cameras(all_c2w, focal, color, sphere_radius, camera_size=1.0):
    ...
    for C2W in all_c2w:
        print("C2W", C2W.shape)
        fig.plot_transform(A2B=C2W, s=0.4)
    fig.show()
    fig.show()
...
if __name__ == '__main__':
    ...
    pose_file_path = '/home/zubairirshad/pd-api-py/scene_000000/scene_df083147fe8ca890d666527c3cd9f239e827828b.json'

    with open(pose_file_path, "r") as read_content:
    ...
    for data in datapoint:
        if "image" in data["datum"].keys():
            print("data", data)
            translation = data["datum"]["image"]["pose"]["translation"]
            Tran = np.array([translation["x"], translation["y"], translation["z"]])
            rotation = data["datum"]["image"]["pose"]["rotation"]
            rotation = [rotation["qw"], rotation["qx"], rotation["qy"], rotation["qz"]]
