...
if __name__ == '__main__':
    ...
    root_dir = '/home/zubairirshad/Downloads/dtu_dataset/rs_dtu_4/DTU/scan1'
    npz_file_path = os.path.join(root_dir, 'cameras.npz')
    # npz_file_path = '/home/zubairirshad/Downloads/dtu_dataset/rs_dtu_4/DTU/scan1/cameras.npz'
    
    all_cam = np.load(npz_file_path)
    camera_size = 0.1
